...
import { mergeExamExtraction } from "@studify/study-core/exam";
...
function EditalContent() {
  ...
  async function save() {
    ...
    const saved = await updateStudyData((current) => mergeExamExtraction(current, {
      title, board, organization, role, examDate: examDate || null,
      questionsTotal: questionsTotal ? Number(questionsTotal) : null,
